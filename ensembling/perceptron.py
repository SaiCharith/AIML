...
class PerceptronClassifier:
    ...
    def sample_data(self, trainingData, trainingLabels, sample_weights):
        ...
        samples = util.nSample(sample_weights,fulldata,m)
        RandtarinData = [x for (x,y) in samples]
        Randlabels = [y for (x,y) in samples] 
        return RandtarinData,Randlabels
